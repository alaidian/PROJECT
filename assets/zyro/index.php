...
error_reporting(E_ALL); @ini_set('display_errors', true);
	...
	$base_url = '/';
	$user_domain = 'agilescrumdashboard.890m.com';
	$show_comments = false;
	include dirname(__FILE__).'/functions.inc.php';
	$home_page = '1';
	list($page_id, $lang, $urlArgs, $route) = parse_uri();
	$user_key = "jyqCSFAl8BjYjhdk/NYtFLavpk/mMrcRr71RdA==";
	$user_hash = "9fda99126e168903";
